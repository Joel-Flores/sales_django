...
class ProductTypeCreate(CreateView):
    ...
    template_name = 'product/product_type/product_type_form.html'
    success_url = reverse_lazy('product:product_type_read')

class ProductTypeRead(ListView):
    model = ProductType
    template_name = 'product/product_type/product_type_read.html'
...
class ProductTypeDelete(DeleteView):
    model = ProductType
    template_name = 'product/product_type/product_type_delete.html'
    success_url = reverse_lazy('product:product_type_read')
